...
@section('principal')
<h4><span>Datos Presupuestos para preparar Factura</span></h4>
<br/>
...
<form role="form" class="form-horizontal" id="presupuestoForm" name="presupuestoForm" 
      action="{{ URL::asset('presupuestos/prepararFactura') }}" method="post">
    <!-- CSRF Token -->
...
//                    });
    ...
    <label>Conceptos (Selecciona las líneas de los conceptos que vayan a la factura)</label>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="FechaVtoFactura" name="FechaVtoFactura" style="text-align:right;" 
                               value="{{ $fechaVtoFactura }}" readonly>
                    </div>
                </div>
            </div>
        </div>
